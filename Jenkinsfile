...
def replicas = "1"
def devProject = "doyager-dev" // TODO: Your dev project name goes here
def testProject = "doyager-test" // TODO: Your test project name goes here
def prodProject = "doyager-prod" // TODO: Your prod project name goes here
        ...
        stage("Setup") {
            steps {
                script {
                    openshift.withCluster(){
                    echo "in script"
                    openshift.withProject("doyager-dev") {
